...
public class ListaPreferitiGUI extends TemplateGUI {
    ...
    public ListaPreferitiGUI(JFrame frame, UtenteService utenteService, String email) {
        ...
        // TODO: sostituire con la richiesta al server (es. TipoRichieste.RECUPERA_PREFERITI)
        // e popolare un JList/JTable con i ristoranti preferiti
        JLabel placeholder = new JLabel("Elenco preferiti non ancora disponibile", SwingConstants.CENTER);
